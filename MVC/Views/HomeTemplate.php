            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="cart">Giỏ hàng: <span class="cart-amunt"></span> <i class="fa fa-shopping-cart"></i> <span class="product-count">0</span></a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="single-product" style="width:250px;height:400px">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <a href="SingleProduct/Show/<?php echo $row['id']?>" class="view-details-link"><i class="fa fa-link"></i> Chi tiết</a>
                                    </div>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        ?>
                        <div class="single-wid-product">
                            <a href="SingleProduct/Show/1"><img src='<?php echo $row['image']?>' alt="" class="product-thumb"></a>
                            <h2><a href="SingleProduct/Show/<?php echo $row['id']?>"><?php echo $row['name']?></a></h2>
                            <div class="product-wid-rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
